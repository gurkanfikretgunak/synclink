...
### App
- Admin overview: clicks-by-page table from GET /api/v1/admin/stats `pageClicks` (missing/null treated as []). Sorted by clicks desc then slug; zero-tap pages included. Empty copy: "No pages yet." Consumes API 0.10.15.
